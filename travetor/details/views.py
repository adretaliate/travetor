...
def show_category(request, cat_slug):
	"""db_category_slug=get_object_or_404(TrekCategory, category_slug=cat_slug)
...
def show_trek(request,tr_slug,cat_slug):
	"""try:
		db_trek=Trek.objects.get(trek_slug=tr_slug)
